...
\begin{equation}
\langle X\rangle 
% In [42]: c.c**2/(1.*u.MeV/c.m_p).to("m**2/s**2")/6.6
...
\end{equation}
The hydrogen fraction at the base will thus be $X_0(1-\Delta t/t_{\rm CNO})$, [{\it should this expression include time dilation?}] so that the average H-fraction in the layer will be $\langle X \rangle = X_0(1-0.5\Delta t/t_{\rm CNO})$. We can combine this expression with equation \ref{xbar} to give
\begin{eqnarray}
X_0 & = & \langle X\rangle +0.35\left(\frac{\Delta t}{9.8\ {\rm hr}}\right)
                            \left(\frac{Z_{\rm CNO}}{0.02}\right) \nonumber \\
    & = & z\frac{142}{\alpha}\frac{\xi_b}{\xi_p} - 0.145 
                           +\left(\frac{\Delta t}{28\ {\rm hr}}\right)
                            \left(\frac{Z_{\rm CNO}}{0.02}\right)
\end{eqnarray}

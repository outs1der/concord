...
def get_weights(con_ver):
    ...
    ========================================================"""
    tdelwts = {1:1., 2:2.5e3, 3:100., 4:2.5e3, 5:2.5e3}   # tdel weights for fitting (for different con_ver)
    fluxwts = {1:1., 2:1., 3:1., 4:1., 5:100.}
...
def get_disc_model(con_ver):
    ...
    ========================================================"""
    discs = {1:'he16_a', 2:'he16_a', 3:'he16_a', 4:'he16_d', 5:'he16_d'}   # tdel weights for fitting (for different con_ver)
...
def get_lhood_floor(con_ver):
    ...
    ========================================================"""
    floors = {2:-5e4, 3:-1e4, 4:-5e4, 5:0.0}    # lower cutoff for lhood plotting
